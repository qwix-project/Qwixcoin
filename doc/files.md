...
* qwix.conf: contains configuration settings for qwixd or qwix-qt
* qwixd.pid: stores the process id of qwixd while running
...
* debug.log: contains debug information and general logging generated by qwixd or qwix-qt
