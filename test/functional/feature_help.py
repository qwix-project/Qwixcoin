...
"""Verify that starting qwix with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qwix with -h for help text")
        ...
        self.log.info("Start qwix with -version for version information")
