...
const char * const BITCOIN_CONF_FILENAME = "qwix.conf";
const char * const BITCOIN_PID_FILENAME = "qwixd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Qwix";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Qwix";
#else
    // Unix
    return pathRet / ".qwix";
#endif
