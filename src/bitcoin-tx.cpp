...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s qwix-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  qwix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qwix transaction") + "\n" +
              "  qwix-tx [options] -create [commands]   " + _("Create hex-encoded qwix transaction") + "\n" +
              "\n";
